...
ActiveRecord::Schema.define(version: 2019_10_22_152505) do
  ...
  create_table "product_articles", force: :cascade do |t|
    ...
    t.bigint "related_sku_id"
    t.index ["product_id"], name: "index_product_articles_on_product_id"
    t.index ["related_sku_id"], name: "index_product_articles_on_related_sku_id"
  end

  create_table "product_photos", force: :cascade do |t|
    t.string "url"
    t.bigint "product_article_id", null: false
